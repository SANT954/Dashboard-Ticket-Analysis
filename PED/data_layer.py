...
ticketicket_data_30="Select TICKET,CATEGORY,DISPOSITION,ASSIGNED,trim(BUG_NUMBER),  CONTROL_NUMBER   from report where status not in ('Solved')  and created< sysdate-30"
